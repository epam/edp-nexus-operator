...
// ExtensionsClient is an autogenerated mock type for the ExtensionsClient type
type ExtensionsClient struct {
	mock.Mock
}

// DaemonSets provides a mock function with given fields: namespace
func (_m *ExtensionsClient) DaemonSets(namespace string) v1beta1.DaemonSetInterface {
...
func (_m *ExtensionsClient) Deployments(namespace string) v1beta1.DeploymentInterface {
	ret := _m.Called(namespace)
...
func (_m *ExtensionsClient) Ingresses(namespace string) v1beta1.IngressInterface {
	ret := _m.Called(namespace)
...
func (_m *ExtensionsClient) NetworkPolicies(namespace string) v1beta1.NetworkPolicyInterface {
	ret := _m.Called(namespace)
...
func (_m *ExtensionsClient) PodSecurityPolicies() v1beta1.PodSecurityPolicyInterface {
	ret := _m.Called()
...
func (_m *ExtensionsClient) RESTClient() rest.Interface {
	ret := _m.Called()
...
func (_m *ExtensionsClient) ReplicaSets(namespace string) v1beta1.ReplicaSetInterface {
	ret := _m.Called(namespace)
