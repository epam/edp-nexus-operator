...
// Ingress is an autogenerated mock type for the Ingress type
type Ingress struct {
	mock.Mock
}

// Create provides a mock function with given fields: ctx, ingress, opts
func (_m *Ingress) Create(ctx context.Context, ingress *v1.Ingress, opts metav1.CreateOptions) (*v1.Ingress, error) {
...
func (_m *Ingress) Get(ctx context.Context, name string, opts metav1.GetOptions) (*v1.Ingress, error) {
	ret := _m.Called(ctx, name, opts)
	var r0 *v1.Ingress
...
func (_m *Ingress) List(ctx context.Context, opts metav1.ListOptions) (*v1.IngressList, error) {
...
func (_m *Ingress) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts metav1.PatchOptions, subresources ...string) (*v1.Ingress, error) {
...
func (_m *Ingress) Update(ctx context.Context, ingress *v1.Ingress, opts metav1.UpdateOptions) (*v1.Ingress, error) {
	ret := _m.Called(ctx, ingress, opts)
	var r0 *v1.Ingress
...
func (_m *Ingress) UpdateStatus(ctx context.Context, ingress *v1.Ingress, opts metav1.UpdateOptions) (*v1.Ingress, error) {
	ret := _m.Called(ctx, ingress, opts)
	var r0 *v1.Ingress
	if rf, ok := ret.Get(0).(func(context.Context, *v1.Ingress, metav1.UpdateOptions) *v1.Ingress); ok {
		r0 = rf(ctx, ingress, opts)
