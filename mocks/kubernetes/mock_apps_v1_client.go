...
func (_m *AppsV1Client) ControllerRevisions(namespace string) v1.ControllerRevisionInterface {
...
func (_m *AppsV1Client) DaemonSets(namespace string) v1.DaemonSetInterface {
	ret := _m.Called(namespace)
...
func (_m *AppsV1Client) Deployments(namespace string) v1.DeploymentInterface {
	ret := _m.Called(namespace)
...
func (_m *AppsV1Client) ReplicaSets(namespace string) v1.ReplicaSetInterface {
	ret := _m.Called(namespace)
...
func (_m *AppsV1Client) StatefulSets(namespace string) v1.StatefulSetInterface {
	ret := _m.Called(namespace)
