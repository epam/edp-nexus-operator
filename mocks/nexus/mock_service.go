...
func (_m *Service) Configure(instance v1alpha1.Nexus) (*v1alpha1.Nexus, bool, error) {
	ret := _m.Called()

	var r0 *v1alpha1.Nexus
	if rf, ok := ret.Get(0).(func(v1alpha1.Nexus) *v1alpha1.Nexus); ok {
		r0 = rf(instance)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*v1alpha1.Nexus)
		}
	}

	var r1 bool
	if rf, ok := ret.Get(1).(func(v1alpha1.Nexus) bool); ok {
		r1 = rf(instance)
	} else {
		r1 = ret.Get(1).(bool)
	}
	...
	var r2 error
	if rf, ok := ret.Get(2).(func(v1alpha1.Nexus) error); ok {
		r2 = rf(instance)
	} else {
		r2 = ret.Error(2)
	}
...
func (_m *Service) ExposeConfiguration(instance v1alpha1.Nexus) (*v1alpha1.Nexus, error) {
...
func (_m *Service) Integration(instance v1alpha1.Nexus) (*v1alpha1.Nexus, error) {
	ret := _m.Called(instance)
...
func (_m *Service) IsDeploymentReady(instance v1alpha1.Nexus) (*bool, error) {
	ret := _m.Called()
