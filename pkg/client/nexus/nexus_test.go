...
func TestClient_CheckScriptExist_GetErr(t *testing.T) {
	...
	assert.Error(t, err)
	assert.True(t, strings.Contains(err.Error(), "Checking if script"))
...
func TestClient_UploadScript_Err(t *testing.T) {
	...
	assert.Error(t, err)
	assert.True(t, strings.Contains(err.Error(), "Uploading script name failed"))
...
func TestClient_DeclareDefaultScripts_UploadScriptErr(t *testing.T) {
	...
	err = client.DeclareDefaultScripts(scriptList)
	assert.Error(t, err)
	assert.True(t, strings.Contains(err.Error(), "Uploading script"))
}
...
func TestClient_CheckTaskExist_GetErr(t *testing.T) {
	...
	assert.False(t, exist)
	assert.Error(t, err)
	assert.True(t, strings.Contains(err.Error(), "Checking if task"))
}
...
func TestClient_RunScript_PostErr(t *testing.T) {
	...
	assert.Error(t, err)
	assert.True(t, strings.Contains(err.Error(), "Running script name failed"))
}
...
func TestClient_CheckRoleExist_PostErr(t *testing.T) {
	...
	assert.Error(t, err)
	assert.True(t, strings.Contains(err.Error(), "Running script get-role failed"))
	assert.False(t, exist)
}
...
func TestClient_GetRepositoryList_GetErr(t *testing.T) {
	...
	assert.Error(t, err)
	assert.Empty(t, list)
	assert.True(t, strings.Contains(err.Error(), "Failed to get repository list from Nexus!"))
}
