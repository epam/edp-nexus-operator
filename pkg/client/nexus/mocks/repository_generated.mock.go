...
func (_mock *MockRepository) Create(ctx context.Context, format string, repoType string, data interface{}) error {
	ret := _mock.Called(ctx, format, repoType, data)
	...
	if returnFunc, ok := ret.Get(0).(func(context.Context, string, string, interface{}) error); ok {
		r0 = returnFunc(ctx, format, repoType, data)
	} else {
		r0 = ret.Error(0)
	}
	return r0
...
func (_c *MockRepository_Create_Call) RunAndReturn(run func(ctx context.Context, format string, repoType string, data interface{}) error) *MockRepository_Create_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_mock *MockRepository) Get(ctx context.Context, id string, format string, repoType string) (interface{}, error) {
	ret := _mock.Called(ctx, id, format, repoType)
	...
	if returnFunc, ok := ret.Get(1).(func(context.Context, string, string, string) error); ok {
		r1 = returnFunc(ctx, id, format, repoType)
	} else {
		r1 = ret.Error(1)
	}
	return r0, r1
...
func (_c *MockRepository_Get_Call) Return(ifaceVal interface{}, err error) *MockRepository_Get_Call {
	_c.Call.Return(ifaceVal, err)
	return _c
}

func (_c *MockRepository_Get_Call) RunAndReturn(run func(ctx context.Context, id string, format string, repoType string) (interface{}, error)) *MockRepository_Get_Call {
	_c.Call.Return(run)
	return _c
}

// Update provides a mock function for the type MockRepository
func (_mock *MockRepository) Update(ctx context.Context, id string, format string, repoType string, data interface{}) error {
	ret := _mock.Called(ctx, id, format, repoType, data)
	...
	var r0 error
	if returnFunc, ok := ret.Get(0).(func(context.Context, string, string, string, interface{}) error); ok {
		r0 = returnFunc(ctx, id, format, repoType, data)
	} else {
		r0 = ret.Error(0)
	}
	return r0
...
func (_c *MockRepository_Update_Call) RunAndReturn(run func(ctx context.Context, id string, format string, repoType string, data interface{}) error) *MockRepository_Update_Call {
	_c.Call.Return(run)
	return _c
}
